...
- Model download microservice is up and running. [Get Started Guide](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.0.0/microservices/model-download/docs/user-guide/get-started.md).
...
4. **Set Up Environment Variables**:
    ...
    For detailed guidance on configuring __ALLOWED_HOSTS__ for different deployment scenarios, refer [ALLOWED_HOSTS Configuration](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.0.0/microservices/document-ingestion/pgvector/docs/user-guide/get-started.md#allowed_hosts-configuration)

...
- Install `Python 3.11`.
- Model download microservice is up and running. [Get Started Guide](https://docs.openedgeplatform.intel.com/2026.0/edge-ai-libraries/model-download/get-started.html).
...
4. **Set Up Environment Variables**:
   ...
   # Mandatory for safe URL ingestion by Document Ingestion Microservice to mitigate SSRF attacks
    ...
    For detailed guidance on configuring __ALLOWED_HOSTS__ for different deployment scenarios, refer to [ALLOWED_HOSTS Configuration](https://docs.openedgeplatform.intel.com/2026.0/edge-ai-libraries/pgvector/get-started.html#allowed-hosts-configuration)

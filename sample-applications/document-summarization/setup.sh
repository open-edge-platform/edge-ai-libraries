...
echo "VOLUME_OVMS=$VOLUME_OVMS" > .env
echo "RELEASE=$RELEASE" >> .env
echo "TAG=$TAG" >> .env
echo "LLM_MODEL=$LLM_MODEL" >> .env
echo "WEIGHT_FORMAT=$WEIGHT_FORMAT" >> .env
echo "TARGET_DEVICE=$TARGET_DEVICE" >> .env
echo "no_proxy=$no_proxy" >> .env
echo "OTEL_SERVICE_NAME=$OTEL_SERVICE_NAME" >> .env
echo "OTEL_SERVICE_ENV=$OTEL_SERVICE_ENV" >> .env
echo "OTEL_SERVICE_VERSION=$OTEL_SERVICE_VERSION" >> .env

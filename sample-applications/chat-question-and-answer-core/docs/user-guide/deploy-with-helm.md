...
- If `configmap.enabled` is set to false, the application will use its default internal configuration. You can view the default configuration template in the [Sample directory](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.2.0/sample-applications/chat-question-and-answer-core/model_config/sample).

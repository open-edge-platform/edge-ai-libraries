...
3. Review the supported embedding models and their dimensions in [Supported Models for Multimodal Embedding Serving](https://docs.openedgeplatform.intel.com/2026.0/edge-ai-libraries/multimodal-embedding-serving/supported-models.html) before switching models.

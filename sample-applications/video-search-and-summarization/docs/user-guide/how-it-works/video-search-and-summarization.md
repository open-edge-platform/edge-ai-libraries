...
1. **Create the Video Search and Summarization pipeline**
   - **Configure the pipeline**: The Video Search and Summarization UI microservice allows you to configure capabilities on the Video Search and Summarization pipeline. You can see [configuration examples for the Video Summarization pipeline](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.2.0/sample-applications/video-search-and-summarization/cli/config).

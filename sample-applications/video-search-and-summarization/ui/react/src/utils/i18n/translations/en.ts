...
export const enTranslations = {
  ...
  searchByImageOrText: 'Search by text or image, not both.',
  searchImageInvalidType: 'Unsupported image type. Use JPG, PNG, or WEBP.',
  searchImageTooLarge: 'Image is too large. Maximum size is {{size}} MB.',
  ...
  timeFilterGroupLabel: 'Date added',
  timeFilterValueLabel: 'Time value',
  timeFilterHelpLabel: 'About the date added filter',
  timeFilterSummary: 'Only videos added in the last {{value}} {{unit}} are searched.',
  timeFilterSummaryAll: 'No time limit. Every video is searched.',
  timeRangeHelp:

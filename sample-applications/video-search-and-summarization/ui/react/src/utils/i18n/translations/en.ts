...
export const enTranslations = {
  ...
  videoSummaryinfo: 'Provide a clear and descriptive title for your video summary. This title will help you identify the summary in the sidebar and search results. By default, it matches the video label, but you can customize it for better clarity.',
  ...
  AudioModelsInfo: 'Select the audio model for transcription or audio analysis. Each model may have different capabilities.',
  ...
  CreateSummaryDescription: 'Review your Parameters and click create new summary button below to start creating your video summary.',
  CreateSummary: 'Create New Summary',
  ReadyToCreateEmbedding: 'Ready to Create Embedding',
  CreateEmbeddingDescription: 'Review your parameters and click create video embedding to start building embeddings for the uploaded video.',

...
import { SearchState, SearchQueryUI, SearchQuery, SearchResult } from '../redux/search/search';
  ...
  describe('Reducers', () => {
    describe('selectQuery', () => {
      it('should select a query by id', () => {
        ...
        const state = store.getState().search;
        expect(state.selectedQuery).toBe(queryId);
      });
  ...
  describe('Async Thunks', () => {
    ...
    describe('SearchAdd', () => {
      it('should handle successful add', async () => {
        ...
        await store.dispatch(SearchAdd('new search query'));

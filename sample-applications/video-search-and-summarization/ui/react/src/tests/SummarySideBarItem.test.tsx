...
import { SummaryActions, SummarySlice } from '../redux/summary/summarySlice';
import { StateActionStatus, EVAMPipelines } from '../redux/summary/summary';
    ...
    await waitFor(() => {
      expect(mockDispatch).toHaveBeenCalledWith(
        expect.objectContaining({
          type: SummaryActions.deleteSummary.type,
          payload: mockSummaryItem.stateId
        })
      );
    });

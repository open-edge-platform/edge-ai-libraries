...
class BenchmarkTestCaseRun(Base):
    ...
    latency_avg_stddev_ms: Mapped[float | None] = mapped_column(Float, nullable=True)
    latency_max_ms: Mapped[float | None] = mapped_column(Float, nullable=True)
    latency_max_stddev_ms: Mapped[float | None] = mapped_column(Float, nullable=True)
    latency_min_ms: Mapped[float | None] = mapped_column(Float, nullable=True)
    latency_min_stddev_ms: Mapped[float | None] = mapped_column(Float, nullable=True)
    score_total: Mapped[float | None] = mapped_column(Float, nullable=True)
    score_performance: Mapped[float | None] = mapped_column(Float, nullable=True)
    score_efficiency: Mapped[float | None] = mapped_column(Float, nullable=True)

...
2. **Download all required files**:
   ...
   curl -Lo models/Dockerfile "https://github.com/open-edge-platform/edge-ai-libraries/raw/refs/heads/release-2026.1.0/tools/visual-pipeline-and-platform-evaluation-tool/models/Dockerfile"
   curl -Lo models/model_manager.sh "https://github.com/open-edge-platform/edge-ai-libraries/raw/refs/heads/release-2026.1.0/tools/visual-pipeline-and-platform-evaluation-tool/models/model_manager.sh"

...
The ViPPET backend lives in [`vippet/`](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.1.0/tools/visual-pipeline-and-platform-evaluation-tool/vippet).
...
- Document each endpoint with a markdown docstring, Swagger renders it.
  See the example in [`AGENTS.md`](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.1.0/tools/visual-pipeline-and-platform-evaluation-tool/AGENTS.md).

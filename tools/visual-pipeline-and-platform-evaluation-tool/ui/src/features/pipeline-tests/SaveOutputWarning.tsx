const SaveOutputWarning = () => {
  return (
    <div className="mt-3 inline-flex max-w-sm min-w-0 text-xs text-popover-foreground bg-popover/95 border border-border rounded-lg px-3 py-2 items-start gap-2">

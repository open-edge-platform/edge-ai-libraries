...
const GVAMetaConvertNode = ({ data }: GVAMetaConvertNodeProps) => {
  ...
  return (
    <div className="p-4 rounded shadow-md bg-background border border-l-4 border-l-node-role-metadata-border min-w-[16.875rem]">
      <div className="flex gap-3">
        <div className="shrink-0 w-10 h-10 rounded bg-node-role-metadata-surface flex items-center justify-center self-center">
          <svg
            className="w-6 h-6 text-node-role-metadata-icon"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="flex-1 flex flex-col">
          <div className="text-xl font-bold text-node-role-metadata-title">
            GVAMetaConvert
          </div>
      ...
      <Handle
        ...
        className="w-3 h-3 bg-node-role-metadata-handle!"

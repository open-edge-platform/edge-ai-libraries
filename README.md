...
| [Vector Retriever](microservices/vector-retriever/) | Microservice | [Link](microservices/vector-retriever/docs/user-guide/get-started.md) | [API Reference](microservices/vector-retriever/docs/user-guide/api-reference.md) |

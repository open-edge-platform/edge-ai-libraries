...
For User-space EtherCAT Master Stack, please visit [Userspace EtherCAT Master Stack](//github.com/open-edge-platform/edge-ai-libraries/blob/main/libraries/edge-control-libraries/fieldbus/ethercat-masterstack/docs/igh_userspace.md) for details.

## Architecture Overview

The architecture is as following:

!["EtherCAT Master Stack Architecture"](//github.com/open-edge-platform/edge-ai-libraries/blob/main/libraries/edge-control-libraries/fieldbus/ethercat-masterstack/docs/images/igh_arch.png)
...
**Note:** If you need DKMS to compile ``master`` and ``device`` modules, please refer to [How to build EtherCAT with DKMS](//github.com/open-edge-platform/edge-ai-libraries/blob/main/libraries/edge-control-libraries/fieldbus/ethercat-masterstack/docs/igh_dkms.md)
...
![Ethernet SysConfig](//github.com/open-edge-platform/edge-ai-libraries/blob/main/libraries/edge-control-libraries/fieldbus/ethercat-masterstack/docs/images/ethercat_sysconfig.png)

* Set **REBIND_NICS**. Use ``lspci`` to query net devices. One of the devices might be specified as an EtherCAT network interface.

![lspci](//github.com/open-edge-platform/edge-ai-libraries/blob/main/libraries/edge-control-libraries/fieldbus/ethercat-masterstack/docs/images/lspci.png)
...
![ifconfig](//github.com/open-edge-platform/edge-ai-libraries/blob/main/libraries/edge-control-libraries/fieldbus/ethercat-masterstack/docs/images/ifconfig.png)

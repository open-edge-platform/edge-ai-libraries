...
- Support for installing plugin dependencies during container startup.
- It highlights that dependencies for selected plugins are automatically installed when the container starts
- Streamlining the setup process for users and ensuring that all necessary components are available for the chosen plugins.

...
1. Pull the specific chart
   ...
   ```bash
   helm pull oci://registry-1.docker.io/intel/model-download-chart --version 2026.1.0-rc1
   ```
...
2. Extract the `.tgz` file
   ...
   ```bash
   tar -xvf model-download-chart-2026.1.0-rc1.tgz
   ```
...
1. Clone the repository containing the Helm chart:
   ...
   # Alternatively, clone a specific release branch
     git clone https://github.com/open-edge-platform/edge-ai-libraries.git edge-ai-libraries -b 2026.1.0-rc1
   ```

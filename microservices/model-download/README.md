...
- **Ephemeral Container**
  - [Running as an Ephemeral Container](./docs/user-guide/quickstart.md#quick-start): Run a one-shot model download or conversion without keeping the service alive.

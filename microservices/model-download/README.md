...
- **Geti Hub Plugin**: Downloads OpenVINO models from Intel Geti Server for optimized inference on Intel hardware.
...
- **Multi-Hub Support**: Download models from multiple sources (HuggingFace, Ollama, Ultralytics, Geti)

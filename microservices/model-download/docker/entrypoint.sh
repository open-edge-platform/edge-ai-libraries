...
install_dependencies() {
    ...
    case $plugin in
        ...
        ultralytics)
            ...
            mkdir -p /opt/scripts
            if curl -fsSL -o /opt/scripts/download_public_models.sh https://raw.githubusercontent.com/open-edge-platform/edge-ai-libraries/2025.2/libraries/dl-streamer/samples/download_public_models.sh; then

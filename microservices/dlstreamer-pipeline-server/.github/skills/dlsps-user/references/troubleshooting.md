...
### `vaCreateContext: resource allocation failed` on Arrow Lake

**Symptom:** GPU inference fails with `resource allocation failed` errors on systems with
Ultra Core 7 265K processor (Ubuntu 22.04).

**Solutions:**

1. Update kernel to `6.11.11-061111-generic` or newer
2. Install OpenCL runtime packages: follow
   [OpenVINO GPU driver docs](https://docs.openvino.ai/2025/get-started/install-openvino/configurations/configurations-intel-gpu.html#linux)

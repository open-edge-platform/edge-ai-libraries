...
FROM intel/dlstreamer-pipeline-server:2026.0.0-extended-ubuntu22-rc1.1 AS ubuntu22-builder
...
FROM intel/dlstreamer-pipeline-server:2026.0.0-extended-ubuntu24 AS ubuntu24-builder

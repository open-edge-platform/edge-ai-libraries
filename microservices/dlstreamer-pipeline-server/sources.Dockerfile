...
FROM intel/dlstreamer-pipeline-server:2026.1.0-extended-ubuntu22-rc2 AS ubuntu22-builder
...
FROM intel/dlstreamer-pipeline-server:2026.1.0-extended-ubuntu24-rc2 AS ubuntu24-builder

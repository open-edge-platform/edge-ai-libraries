...
> **Note:** Refer to this [tutorial](./change-dlstreamer-pipeline.md) and this [section](../advanced-guide/detailed_usage/configuration/Overview.md) for configuration file.

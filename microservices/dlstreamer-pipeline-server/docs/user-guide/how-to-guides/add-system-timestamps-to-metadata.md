...
Ensure that the changes made to the `config.json` are reflected in the container by volume mounting it as mentioned in this [tutorial](./change-dlstreamer-pipeline.md)

...
- To perform decode and inference on GPU or NPU, please see [this document](./use-gpu-npu-for-decode-and-inference.md). For more combinations of different devices for decode and inference, please see [this document](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/dev_guide/performance_guide.md).

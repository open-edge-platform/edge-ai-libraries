...
>**Refer to [Generic-Plugin-readme](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.1.0/microservices/dlstreamer-pipeline-server/plugins/camera/src-gst-gencamsrc/README.md) for more information on Generic Plugin**
 ----

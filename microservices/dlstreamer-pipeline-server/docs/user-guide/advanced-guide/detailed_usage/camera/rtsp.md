...
- Refer to the following pipeline for RTSP camera and modify the appropriate `config.json` file
in `[WORKDIR]/edge-ai-libraries/microservices/dlstreamer-pipeline-server/configs` directory.

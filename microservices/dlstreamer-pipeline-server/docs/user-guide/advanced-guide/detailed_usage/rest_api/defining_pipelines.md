...
> [here](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/supported_models.md).
> Refer to the documentation for DL Streamer on how to download any given model for your
> usage [here](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/dev_guide/model_preparation.md).
...
> **Note:**: The model used in the above pipeline is an example of how it can be used from [here](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/supported_models.md).
> Refer to the documentation for DL Streamer on how to download any given model for your
> usage [here](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/dev_guide/model_preparation.md).
...
> your usage [here](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/dev_guide/model_preparation.md).
...
with DL Streamer please see the [tutorial](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/get_started/tutorial.md).
...
For more details on model proc and labels see [Model Proc File](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/dev_guide/model_proc_file.md).
...
[documentation](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/dev_guide/how_to_create_model_proc_file.md#how-to-create-model-proc-file).
and
[samples](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0/samples).
...
> **Note:**: The mentioned model is available [here](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/user-guide/supported_models.md).

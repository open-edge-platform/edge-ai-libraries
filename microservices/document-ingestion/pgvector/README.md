...
- **Use Case 1**: Refer to the [Chat Q&A](https://docs.openedgeplatform.intel.com/2026.0/edge-ai-libraries/chat-question-and-answer/index.html) sample application where this microservice is used.

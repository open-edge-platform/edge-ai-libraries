...
- Using pre-built helm charts:
    ...
    1. Download helm chart with the following command
        ...
        `helm pull oci://registry-1.docker.io/intel/time-series-analytics-microservice --version 2026.0.<date>-weekly`

        Replace `<date>` with the actual patch version date (e.g., `20260120` for January 20th, 2026).
        `helm pull oci://registry-1.docker.io/intel/time-series-analytics-microservice --version 2026.0.20260120-weekly`

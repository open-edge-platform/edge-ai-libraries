...
- Using pre-built helm charts:
    ...
    1. Download helm chart with the following command
        ...
        `helm pull oci://registry-1.docker.io/intel/ia-time-series-analytics-microservice --version 2026.0.0-helm`

    2. unzip the package using the following command

        `tar -xvzf ia-time-series-analytics-microservice-2026.0.0-helm.tgz`

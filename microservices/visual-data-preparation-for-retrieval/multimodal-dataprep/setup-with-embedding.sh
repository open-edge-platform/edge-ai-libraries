...
echo -e "   Device: ${YELLOW}${MULTIMODAL_DATAPREP_DEVICE}${NC}"
...
echo -e "   • ${YELLOW}MULTIMODAL_DATAPREP_DEVICE=GPU ./embedding-setup.sh${NC} - SDK mode with GPU acceleration and validation"

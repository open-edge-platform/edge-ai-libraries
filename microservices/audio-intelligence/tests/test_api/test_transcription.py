...
from audio_intelligence.schemas.types import StorageBackend, TranscriptionStatus


@pytest.mark.api
@pytest.mark.asyncio
@patch("audio_intelligence.utils.validation.settings")
@patch("audio_intelligence.api.endpoints.transcription.get_video_path")
@patch("audio_intelligence.api.endpoints.transcription.AudioExtractor.extract_audio")
@patch("audio_intelligence.api.endpoints.transcription.get_file_duration")
@patch("audio_intelligence.api.endpoints.transcription.store_transcript_output")
...
@pytest.mark.api
@pytest.mark.asyncio
@patch("audio_intelligence.utils.validation.MinioHandler.ensure_bucket_exists")
@patch("audio_intelligence.utils.validation.settings")
@patch("audio_intelligence.api.endpoints.transcription.get_video_path")
@patch("audio_intelligence.api.endpoints.transcription.AudioExtractor.extract_audio")
@patch("audio_intelligence.api.endpoints.transcription.get_file_duration")

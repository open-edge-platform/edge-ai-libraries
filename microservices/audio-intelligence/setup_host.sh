...
echo "==== Audio Intelligence Service Setup ===="
...
mkdir -p /tmp/audio_intelligence_model/ggml
mkdir -p /tmp/audio_intelligence_model/openvino
...
echo "==== Setup complete! ===="
echo "Starting the Audio Intelligence service..."
echo "You can access the API at http://localhost:8000/docs"

poetry run uvicorn audio_intelligence.main:app --host 0.0.0.0 --port 8000 --timeout-keep-alive 200 $RELOAD_ARG